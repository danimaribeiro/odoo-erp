openerp.web.page = function (openerp) {
    ...
    * Integra
    */
    openerp.web.page.FieldOnlyEditReadonly = openerp.web.page.FieldCharReadonly
            .extend({
                init : function(view, node) {
                    this._super(view, node);
                },
    ...
    openerp.web.page.FieldPriceFormatReadonly = openerp.web.page.FieldCharReadonly
            .extend({
                init : function(view, node) {
                    this._super(view, node);
                },
                set_value : function(value) {
                    this._super.apply(this, arguments);
                    var show_value = openerp.web.parse_value_price(value);
    ...
    */
    ...
    openerp.web.page.readonly = openerp.web.form.widgets.extend({
        ...
        * Integra
        */
        'historicformat' : 'openerp.web.page.FieldCharReadonly',
        'planocontaformat' : 'openerp.web.page.FieldCharReadonly',
        'onlyedit' : 'openerp.web.page.FieldOnlyEditReadonly',
        'priceformat' : 'openerp.web.page.FieldPriceFormatReadonly',
        /*
        * Integra --- FIM
        */
    });
