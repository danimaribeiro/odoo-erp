...
from pybrasil.valor.decimal import Decimal as DecimalAutoFloat
...
class NonLiteralEncoder(simplejson.encoder.JSONEncoder):
    def default(self, object):
        if not isinstance(object, (BaseDomain, BaseContext, Decimal, DecimalAutoFloat)):
        ...
        elif isinstance(object, (Decimal, DecimalAutoFloat)):
