...
class JsonRequest(WebRequest):
    ...
    def dispatch(self, controller, method):
        ...
        if jsonp:
            ...
            body = "%s(%s);" % (jsonp, simplejson.dumps(response, cls=nonliterals.NonLiteralEncoder, use_decimal=True),)
        else:
            mime = 'application/json'
            body = simplejson.dumps(response, cls=nonliterals.NonLiteralEncoder, use_decimal=True)
