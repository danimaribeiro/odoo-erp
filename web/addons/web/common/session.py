...
class OpenERPSession(object):
    ...
    def base_eval_context(self):
        ...
        base = dict(
            ...
            hoje=pybrasil.data.hoje(),
            amanha=pybrasil.data.amanha(),
            ontem=pybrasil.data.ontem(),
            mes_que_vem=pybrasil.data.mes_que_vem(),
            mes_passado=pybrasil.data.mes_passado(),
            ano_que_vem=pybrasil.data.ano_que_vem(),
            ano_passado=pybrasil.data.ano_passado(),
            semana_que_vem=pybrasil.data.semana_que_vem(),
            semana_passada=pybrasil.data.semana_passada(),
            primeiro_dia_mes=pybrasil.data.primeiro_dia_mes,
            ultimo_dia_mes=pybrasil.data.ultimo_dia_mes,
            data_hora_horario_brasilia=pybrasil.data.data_hora_horario_brasilia,
            parse_datetime=pybrasil.data.parse_datetime,
            int=int,
            str=str,
            unicode=unicode,
            pybrasil=pybrasil,
