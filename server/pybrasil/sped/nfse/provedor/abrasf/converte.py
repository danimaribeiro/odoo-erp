...
def gera_rps(lista_notas, numero_lote, certificado=None):
    ...
    for nota in lista_notas:
        ...
        if nota.condicao_pagamento == 'A VISTA':
            ...
            rps.InfRps.CondicaoPagamento['Condicao'] = 'A_VISTA'
            rps.InfRps.CondicaoPagamento['QtdParcela'] = 1
            rps.InfRps.CondicaoPagamento['Parcelas'] = DicionarioBrasil()
            rps.InfRps.CondicaoPagamento.Parcelas['Parcela'] = 1
            rps.InfRps.CondicaoPagamento.Parcelas['DataVencimento'] = nota.rps.data_emissao_iso
            rps.InfRps.CondicaoPagamento.Parcelas['Valor'] = nota.valor.liquido

        else:
            rps.InfRps['CondicaoPagamento'] = DicionarioBrasil()
            rps.InfRps.CondicaoPagamento['Condicao'] = 'A_PRAZO'
            rps.InfRps.CondicaoPagamento['QtdParcela'] = len(nota.parcelas)
            rps.InfRps.CondicaoPagamento['Parcelas'] = []
            for parcela in nota.parcelas:
                ...
                rps.InfRps.CondicaoPagamento.Parcelas.append(parc)
    ...
    #enviarloterpsenvio['__xmlns:e'] = 'http://www.betha.com.br/e-nota-contribuinte-ws'
