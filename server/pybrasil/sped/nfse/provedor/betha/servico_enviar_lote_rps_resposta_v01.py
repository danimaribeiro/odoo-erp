...
#
# Generated Tue Dec 31 15:55:05 2013 by generateDS.py version 2.12a.
#
...
class EnviarLoteRpsResposta(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, NumeroLote=None, DataRecebimento=None, Protocolo=None, MensagemRetorno=None):
    ...
    def validate_tsNumeroProtocolo(self, value):
        # Validate type tsNumeroProtocolo, a restriction on xs:long.
        pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', namespacedef_=' xmlns:tipos="http://www.betha.com.br/e-nota-contribuinte-ws/tipos" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.Protocolo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sProtocolo>%s</%sProtocolo>%s' % (namespace_, self.gds_format_integer(self.Protocolo, input_name='Protocolo'), namespace_, eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroLote':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'Protocolo')
            self.Protocolo = ival_
...
def parseString(inString, silence=False):
    ...
    if not silence:
        sys.stdout.write('<?xml version="1.0" ?>\n')
        rootObj.export(
            sys.stdout, 0, name_="EnviarLoteRpsResposta",
            namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_enviar_lote_rps_resposta_v01 import *\n\n')
        sys.stdout.write('import servico_enviar_lote_rps_resposta_v01 as model_\n\n')
