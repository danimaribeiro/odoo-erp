...
#
# Generated Tue Dec 31 15:56:19 2013 by generateDS.py version 2.12a.
#
...
class ConsultarLoteRpsEnvio(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ConsultarLoteRpsEnvio', namespacedef_=' xmlns:tipos="http://www.betha.com.br/e-nota-contribuinte-ws/tipos" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseString(inString, silence=False):
    ...
    if not silence:
        sys.stdout.write('<?xml version="1.0" ?>\n')
        rootObj.export(
            sys.stdout, 0, name_="ConsultarLoteRpsEnvio",
            namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_consultar_lote_rps_envio_v01 import *\n\n')
        sys.stdout.write('import servico_consultar_lote_rps_envio_v01 as model_\n\n')
