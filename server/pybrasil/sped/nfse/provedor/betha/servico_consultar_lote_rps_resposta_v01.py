...
#
# Generated Tue Dec 31 15:57:04 2013 by generateDS.py version 2.12a.
#
...
class ConsultarLoteRpsResposta(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.ListaMensagemRetorno is not None:
            showIndent(outfile, level)
            outfile.write('ListaMensagemRetorno=model_.ListaMensagemRetornoType(\n')
            self.ListaMensagemRetorno.exportLiteral(outfile, level, name_='ListaMensagemRetorno')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ListaNfse':
            ...
            obj_ = ListaMensagemRetornoType.factory()
            obj_.build(child_)
...
class ListaMensagemRetornoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ListaMensagemRetornoType', namespacedef_=' xmlns:tipos="http://www.betha.com.br/e-nota-contribuinte-ws/tipos" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ListaMensagemRetornoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaMensagemRetornoType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ListaMensagemRetornoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for MensagemRetorno_ in self.MensagemRetorno:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMensagemRetorno>%s</%sMensagemRetorno>%s' % (namespace_, self.gds_format_string(quote_xml(MensagemRetorno_).encode(ExternalEncoding), input_name='MensagemRetorno'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='ListaMensagemRetornoType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for MensagemRetorno_ in self.MensagemRetorno:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(MensagemRetorno_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
...
GDSClassesMapping = {
    'ListaMensagemRetorno': ListaMensagemRetornoType,
...
def parseString(inString, silence=False):
    ...
    if not silence:
        sys.stdout.write('<?xml version="1.0" ?>\n')
        rootObj.export(
            sys.stdout, 0, name_="ConsultarLoteRpsResposta",
            namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_consultar_lote_rps_resposta_v01 import *\n\n')
        sys.stdout.write('import servico_consultar_lote_rps_resposta_v01 as model_\n\n')
