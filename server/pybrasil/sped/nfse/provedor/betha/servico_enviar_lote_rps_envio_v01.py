...
#
# Generated Mon Dec 30 11:48:06 2013 by generateDS.py version 2.12a.
#
...
from ....base import SignatureType
...
try:
    ...
    class GeneratedsSuper(object):
        ...
        def gds_format_aliquota(self, input_data, input_name=''):
            return ('%.4f' % input_data).rstrip('0')
...
class EnviarLoteRpsEnvio(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='e:', name_='EnviarLoteRpsEnvio', namespacedef_='xmlns:e="http://www.betha.com.br/e-nota-contribuinte-ws"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tcIdentificacaoPrestador(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='IdentificacaoPrestador', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='IdentificacaoPrestador'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='IdentificacaoPrestador', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tcIdentificacaoTomador(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='IdentificacaoTomador', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='IdentificacaoTomador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='IdentificacaoTomador'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='IdentificacaoTomador', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.InscricaoMunicipal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoMunicipal>%s</%sInscricaoMunicipal>%s' % (namespace_, self.gds_format_integer(self.InscricaoMunicipal, input_name='InscricaoMunicipal'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='IdentificacaoTomador'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcLoteRps(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='LoteRps', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='LoteRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='LoteRps'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_format_string(quote_attrib(self.Id).encode(ExternalEncoding), input_name='Id'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='LoteRps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='LoteRps'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcRps(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='Rps', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='Rps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Rps'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='Rps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Signature is not None:
            self.Signature.export(outfile, level, namespace_='', name_='Signature', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='Rps'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcInfRps(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='InfRps', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='InfRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='InfRps'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_format_string(quote_attrib(self.Id).encode(ExternalEncoding), input_name='Id'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='InfRps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='InfRps'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcIdentificacaoRps(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='IdentificacaoRps', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='IdentificacaoRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='IdentificacaoRps'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='IdentificacaoRps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='IdentificacaoRps'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class TcValores(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TcValores', fromsubclass_=False, pretty_print=True):
        ...
        if self.Aliquota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAliquota>%s</%sAliquota>%s' % (namespace_, self.gds_format_aliquota(self.Aliquota, input_name='Aliquota'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.ValorServicos is not None:
            showIndent(outfile, level)
            outfile.write('ValorServicos=%13.2f,\n' % self.ValorServicos)
        if self.ValorDeducoes is not None:
            showIndent(outfile, level)
            outfile.write('ValorDeducoes=%13.2f,\n' % self.ValorDeducoes)
        if self.ValorPis is not None:
            showIndent(outfile, level)
            outfile.write('ValorPis=%13.2f,\n' % self.ValorPis)
        if self.ValorCofins is not None:
            showIndent(outfile, level)
            outfile.write('ValorCofins=%13.2f,\n' % self.ValorCofins)
        if self.ValorInss is not None:
            showIndent(outfile, level)
            outfile.write('ValorInss=%13.2f,\n' % self.ValorInss)
        if self.ValorIr is not None:
            showIndent(outfile, level)
            outfile.write('ValorIr=%13.2f,\n' % self.ValorIr)
        if self.ValorCsll is not None:
            showIndent(outfile, level)
            outfile.write('ValorCsll=%13.2f,\n' % self.ValorCsll)
        if self.IssRetido is not None:
            showIndent(outfile, level)
            outfile.write('IssRetido=%d,\n' % self.IssRetido)
        if self.ValorIss is not None:
            showIndent(outfile, level)
            outfile.write('ValorIss=%13.2f,\n' % self.ValorIss)
        if self.OutrasRetencoes is not None:
            showIndent(outfile, level)
            outfile.write('OutrasRetencoes=%13.2f,\n' % self.OutrasRetencoes)
        if self.BaseCalculo is not None:
            showIndent(outfile, level)
            outfile.write('BaseCalculo=%13.2f,\n' % self.BaseCalculo)
        if self.Aliquota is not None:
            showIndent(outfile, level)
            outfile.write('Aliquota=%1.4f,\n' % self.Aliquota)
        if self.ValorLiquidoNfse is not None:
            showIndent(outfile, level)
            outfile.write('ValorLiquidoNfse=%13.2f,\n' % self.ValorLiquidoNfse)
        if self.ValorIssRetido is not None:
            showIndent(outfile, level)
            outfile.write('ValorIssRetido=%13.2f,\n' % self.ValorIssRetido)
        if self.DescontoCondicionado is not None:
            showIndent(outfile, level)
            outfile.write('DescontoCondicionado=%13.2f,\n' % self.DescontoCondicionado)
        if self.DescontoIncondicionado is not None:
            showIndent(outfile, level)
            outfile.write('DescontoIncondicionado=%13.2f,\n' % self.DescontoIncondicionado)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tcDadosTomador(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DadosTomador', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DadosTomador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DadosTomador'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DadosTomador', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='DadosTomador'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcDadosConstrucaoCivil(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='DadosConstrucaoCivil', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DadosConstrucaoCivil')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DadosConstrucaoCivil'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DadosConstrucaoCivil', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='DadosConstrucaoCivil'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcPedidoCancelamento(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='PedidoCancelamento', namespacedef_='xmlns="http://www.betha.com.br/e-nota-contribuinte-ws/tipos"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoCancelamento'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoCancelamento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Signature is not None:
            self.Signature.export(outfile, level, namespace_='', name_='Signature', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='PedidoCancelamento'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcInfPedidoCancelamento(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='InfPedidoCancelamento', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='InfPedidoCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='InfPedidoCancelamento'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_format_string(quote_attrib(self.Id).encode(ExternalEncoding), input_name='Id'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='InfPedidoCancelamento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='InfPedidoCancelamento'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class tcIdentificacaoNfse(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='IdentificacaoNfse', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='IdentificacaoNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='IdentificacaoNfse'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='IdentificacaoNfse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CodigoMunicipio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCodigoMunicipio>%s</%sCodigoMunicipio>%s' % (namespace_, self.gds_format_integer(self.CodigoMunicipio, input_name='CodigoMunicipio'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='IdentificacaoNfse'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ListaRpsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Rps_ in self.Rps:
            ...
            Rps_.exportLiteral(outfile, level, name_='Rps')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
def parseString(inString, silence=True):
    ...
    if not silence:
        sys.stdout.write('<?xml version="1.0" ?>\n')
        rootObj.export(
            sys.stdout, 0, name_="EnviarLoteRpsEnvio",
            namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName, silence=True):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_enviar_lote_rps_envio_v01 import *\n\n')
        sys.stdout.write('import servico_enviar_lote_rps_envio_v01 as model_\n\n')
