...
def calcula_digito_nosso_numero(self, boleto):
    ...
    calculo_digito += str(boleto.beneficiario.codigo_beneficiario.numero).zfill(8)
...
def campo_livre(self, boleto):
    ...
    boleto.beneficiario.codigo_beneficiario.numero = str(boleto.beneficiario.codigo_beneficiario.numero).zfill(7)
    ...
    campo_livre = boleto.beneficiario.conta.convenio.zfill(6)
...
def agencia_conta(self, boleto):
    ...
    return '%s-%s / %s-%s' % (str(boleto.beneficiario.agencia.numero).zfill(4), str(boleto.beneficiario.agencia.digito).zfill(1),  str(boleto.beneficiario.codigo_beneficiario.numero).zfill(7), str(boleto.beneficiario.codigo_beneficiario.digito).zfill(1))


def carteira_nosso_numero(self, boleto):
    return '%s%s%s' % (str(boleto.beneficiario.codigo_beneficiario.numero).zfill(7), str(boleto.beneficiario.codigo_beneficiario.digito).zfill(1), str(boleto.nosso_numero).zfill(9))
...
def header_remessa_400(self, remessa):
    ...
    texto += str(beneficiario.codigo_beneficiario.numero).zfill(8)
...
def header_retorno_400(self, retorno):
    ...
    beneficiario.codigo_beneficiario.numero = unicode(D(header[31:39])).zfill(6)
