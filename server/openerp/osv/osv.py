...
class object_proxy(object):
    ...
    def check(f):
        ...
        def wrapper(self, dbname, *args, **kwargs):
            ...
            tries = 0
            while True:
                if DEBUGA_PERMISSOES:
                    if pooler.get_pool(dbname)._init:
                        raise except_osv(u'Banco de dados em atualização', u'Neste momento está ocorrendo uma atualização do banco de dados, tente novamente em alguns instantes...')
