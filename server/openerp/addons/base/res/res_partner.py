...
class res_partner_title(osv.osv):
    ...
    _columns = {
        ...
        'shortcut': fields.char('Shortcut', required=False, size=16, translate=True),
        'domain': fields.selection([('partner','Partner'),('contact','Contact')], 'Domain', required=False, size=24)
    }
    _order = 'name'
res_partner_title()
