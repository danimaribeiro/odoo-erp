        ...
        <page string="Products">
            <field colspan="4" name="move_lines" nolabel="1" widget="one2many_list" context="{'address_out_id': address_id, 'picking_type': type}" invisible="1">
                <tree colors="grey:scrapped==True" string="Stock Moves">
                    ...
                    <field name="tracking_id" groups="base.group_extended" invisible="1" />
...
RODAPE_FORM = u'''
            <group col="12" colspan="4">
                ...
                <button name="369" string="Return Products" states="done" type="action" icon="gtk-execute"/>
                <button name="363" string="Create Invoice" attrs="{'invisible': ['|','|',('state','&lt;&gt;','done'),('invoice_state','=','invoiced'),('invoice_state','=','none')]}" type="action" icon="terp-gtk-go-back-rtl"/>
            </group>
        </page>
...
CORPO_FORM = u'''
            <group string="{categoria_nome}" colspan="10">
                <field colspan="4" name="{nome_campo}" nolabel="1" widget="one2many_list" context="{{'address_out_id': address_id, 'picking_type': type, 'default_orcamento_categoria_id': {categoria_id}}}">
                    <tree colors="grey:scrapped==True" string="Stock Moves">
