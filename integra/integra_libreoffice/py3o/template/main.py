...
from integra_libreoffice.pyjon.utils import get_secure_filename
...
def format_amount(amount, format="%f"):
    ...
    """
    if isinstance(amount, (float, decimal.Decimal, pybrasil.valor.decimal.Decimal)):
...
class Template(object):
    ...
    def add_base_data_to_template(self):
        return {
            #"decimal": decimal,
            "decimal": pybrasil.valor.decimal,
