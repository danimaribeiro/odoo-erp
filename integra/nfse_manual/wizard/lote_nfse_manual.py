    ...
    def action_enviar_nfse(self, cr, uid, ids, context={}):
        ...
        if ids_ordenados:
            for id in ids_ordenados:
                ...
                if doc_obj.company_id.provedor_nfse != 'JOINVILLE' or doc_obj.state in ['autorizada']:
                    continue
        ...
        try:
            resposta_envia_rps = envia_rps_joinville(lista_notas, numero_lote_rps, certificado='')
        except:
            resposta_envia_rps = ''
