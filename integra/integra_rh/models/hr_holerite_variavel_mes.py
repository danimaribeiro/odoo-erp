...
class hr_holerite_variavel(osv.osv_memory):
    _name = 'hr.holerite_variavel'
    _description = u'Variáveis do holerite'
    _order = 'company_id, data_inicial, data_final'
    ...
    def _get_input_ids(self, cr, uid, ids, nome_campo, args=None, context={}):
        ...
        for variavel_obj in self.browse(cr, uid, ids):
            ...
            if variavel_obj.rule_id:
                sql += """
                    and v.rule_id = {rule_id}
                """
                filtro['rule_id'] = variavel_obj.rule_id.id
    ...
    _columns = {
        ...
        'exige_valor': fields.related('rule_id', 'exige_valor', type='boolean', string=u'Exige valor?'),
        'tipo_media': fields.related('rule_id', 'tipo_media', type='char', string=u'Tipo média'),
