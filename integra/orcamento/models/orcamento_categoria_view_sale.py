...
CORPO_FORM = u'''
    <group string="{categoria_nome}" colspan="10">
        <field name="{nome_campo}" colspan="10" nolabel="1" widget="one2many_list" mode="tree,form" attrs="{{'readonly': [('state', '!=', 'draft')]}}" context="{{'default_orcamento_categoria_id': {categoria_id}, 'form_view_ref': 'orcamento.orcamento_sale_order_line_form', 'tree_view_ref': 'orcamento.orcamento_sale_order_line_tree'}}" />
    </group>
'''
